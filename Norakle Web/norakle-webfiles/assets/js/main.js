! function(e) {
    ...
    jQuery(".mean-menu").meanmenu({
        ...
        function(e) {
            ...
            e(this).scrollTop() > 120 ? e(".norakle-nav").addClass("is-sticky") : e(".norakle-nav").removeClass("is-sticky")
...
function setTheme(themeName) {
	localStorage.setItem('norakle_theme', themeName);
	document.documentElement.className = themeName;
}
// function to toggle between light and dark theme
function toggleTheme() {
	if (localStorage.getItem('norakle_theme') === 'theme-dark') {
...
function onPlayerStateChange(event) {
    if (event.data == YT.PlayerState.PLAYING && !done) {
      // we can do some other custom stuff here
